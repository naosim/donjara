/**
 * QRCode.js - Standard Lightweight QR Code Generator (Offline)
 * Supports dynamic text sizes up to Version 40 without array boundary errors.
 */
(function (global) {
  var QRCodeLimitLength = [
    [17, 14, 11, 7], [32, 26, 20, 14], [53, 42, 32, 24], [78, 62, 46, 34],
    [106, 84, 60, 44], [134, 106, 74, 58], [154, 122, 86, 64], [192, 152, 108, 84],
    [230, 180, 130, 98], [271, 213, 151, 119], [321, 251, 181, 137], [367, 287, 203, 155],
    ...
    [929, 711, 534, 403], [1003, 779, 581, 441], [1091, 857, 631, 464], [1171, 911, 676, 514],
    [1273, 997, 742, 538], [1367, 1059, 790, 596], [1465, 1125, 842, 628], [1528, 1190, 898, 661],
    [1628, 1264, 958, 701], [1732, 1370, 983, 745], [1840, 1452, 1051, 793], [1952, 1538, 1097, 845],
    [2068, 1628, 1158, 901], [2188, 1722, 1224, 961], [2303, 1809, 1284, 986], [2431, 1911, 1354, 1054],
    [2563, 1989, 1426, 1096], [2699, 2099, 1502, 1142], [2809, 2213, 1582, 1222], [2953, 2331, 1666, 1276]
  ];
  ...
  function QRPolynomial(num, shift) {
    if (num.length == undefined) throw new Error(num + "/" + shift);
    var offset = 0;
  ...
  QRRSBlock.RS_BLOCK_TABLE = [
    ...
    [4, 101, 81], [1, 110, 80, 4, 111, 81], [4, 50, 22, 4, 51, 23], [3, 36, 12, 8, 37, 13],
    ...
    [8, 132, 106, 4, 133, 107], [8, 79, 47, 13, 80, 48], [7, 54, 24, 22, 55, 25], [22, 45, 15, 13, 46, 16],
    [10, 142, 114, 2, 143, 115], [19, 74, 46, 4, 75, 47], [28, 50, 22, 6, 51, 23], [33, 46, 16, 4, 47, 17],
    [8, 152, 122, 4, 153, 123], [22, 73, 45, 3, 74, 46], [8, 53, 23, 26, 54, 24], [12, 45, 15, 28, 46, 16],
    [3, 147, 117, 10, 148, 118], [3, 73, 45, 23, 74, 46], [4, 54, 24, 31, 55, 25], [11, 45, 15, 31, 46, 16],
    [7, 146, 116, 7, 147, 117], [21, 73, 45, 7, 74, 46], [1, 53, 23, 37, 54, 24], [19, 45, 15, 26, 46, 16],
    [5, 145, 115, 10, 146, 116], [19, 75, 47, 10, 76, 48], [15, 54, 24, 25, 55, 25], [23, 45, 15, 25, 46, 16],
    [13, 145, 115, 3, 146, 116], [10, 74, 46, 20, 75, 47], [42, 54, 24, 1, 55, 25], [23, 45, 15, 28, 46, 16],
  ...
  // Automatic TypeNumber calculation for any string length
  function getOptimalTypeNumber(textLen, ecl) {
    for (var t = 1; t <= 40; t++) {
      if (textLen <= QRCodeLimitLength[t - 1][ecl]) return t;
    }
    return 40;
  }

  var QRCode = {
    renderQRCode: function (canvasId, text, size) {
      size = size || 180;
      var ecl = QRErrorCorrectLevel.L;
      var typeNum = getOptimalTypeNumber(text.length, ecl);

      var qr = new QRCodeModel(typeNum, ecl);
      qr.addData(text);
      qr.make();
